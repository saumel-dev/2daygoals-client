...
const Hero = () => {
    return (
        <section className="relative container mx-auto px-4 sm:px-6">
                ...
                <motion.div variants={fadeUp} className="shrink-0">
                    <Link href="/register" className="group inline-flex">
                        <motion.span
                            ...
                            className="inline-flex items-center gap-3 rounded-[8px] bg-black p-1.5 pr-4 shadow-lg"
                        >
                            <motion.span
                                className="flex h-8 w-12 items-center justify-center rounded-[6px] bg-gradient-to-r from-[#73FDB2] to-[#6EFF00]"
                            >
            ...
            >
                <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-b from-[#DEE9EE] to-[#F2F6F8] p-3 sm:p-5 md:p-7.5 shadow-[0_45px_60px_-15px_rgba(0,0,0,0.12)] ring-1 ring-white/80 filter drop-shadow-[0_20px_20px_rgba(200,220,230,0.6)]">
